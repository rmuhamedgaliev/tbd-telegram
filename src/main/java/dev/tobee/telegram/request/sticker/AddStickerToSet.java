...
import dev.tobee.telegram.request.body.AddStickerToSetBody;
import dev.tobee.telegram.util.DefaultObjectMapper;

public class AddStickerToSet implements Request<ResponseWrapper<Boolean>> {
    ...
    private final AddStickerToSetBody body;

    public AddStickerToSet(AddStickerToSetBody body) {
        this.body = body;
    }
